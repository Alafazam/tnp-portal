...
<div class="form-group">
  ...
  <div class="col-md-4">
    <select id="cursem" name="cursem" class="form-control">
      <option <?php if ($cursem==='1') {echo 'selected'}?> value="1">I</option>
...
<div class="form-group row">
  ...
  <div class="col-md-2">
  <input id="sem1" name="sem1" value="<?php if ($sem1) {echo $sem1}?>" type="text" placeholder="SGPA I" class="form-control input-md">
  </div>
  <label class="col-md-2 control-label" for="sem2">Semester II</label>  
  <div class="col-md-2">
  <input id="sem2" name="sem2" value="<?php if ($sem2) {echo $sem2}?>" type="text" placeholder="SGPA II" class="form-control input-md">    
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-2">
  <input id="sem3" name="sem3" value="<?php if ($sem3) {echo $sem3}?>" type="text" placeholder="SGPA III" class="form-control input-md">
  </div>
  <label class="col-md-2 control-label" for="sem4">Semester IV</label>  
  <div class="col-md-2">
  <input id="sem4" name="sem4" value="<?php if ($sem4) {echo $sem4}?>" type="text" placeholder="SGPA IV" class="form-control input-md">
  </div>
</div>
<!-- Text input-->
<div class="form-group">
  ...
  <div class="col-md-2">
  <input id="sem5" name="sem5" value="<?php if ($sem5) {echo $sem5}?>" type="text" placeholder="SGPA V" class="form-control input-md">
  </div>
  <label class="col-md-2 control-label" for="sem6">Semester VI</label>  
  <div class="col-md-2">
  <input id="sem6" name="sem6" value="<?php if ($sem6) {echo $sem6}?>" type="text" placeholder="SGPA VI" class="form-control input-md"> 
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-2">
  <input id="sem7" name="sem7" value="<?php if ($sem7) {echo $sem7}?>" type="text" placeholder="SGPA VII" class="form-control input-md">
  </div>
  <label class="col-md-2 control-label" for="sem8">Semester VIII</label>  
  <div class="col-md-2">
  <input id="sem8" name="sem8" value="<?php if ($sem8) {echo $sem8}?>" type="text" placeholder="SGPA VIII" class="form-control input-md"> 
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">                     
    <textarea class="form-control" id="reason" name="reason"><?php if ($reason) {echo $reason}?></textarea>
  </div>
</div>
<!-- Text input-->
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="cgpa" name="cgpa" value="<?php if (cgpa) {echo 'selected'}?>" type="text" placeholder="CGPA" class="form-control input-md">
  </div>
</div>
<!-- Button -->
<div class="form-group">
