    ...
    foreach ($feeds as $key) {
        ...
        echo "<article class='timeline-entry'>
                ...
                <div class='timeline-entry-inner'>" . $type . "<div class='timeline-label'>
                    ...
                    <a href='/admin_feeds/edit_this_feed/" . $key["feed_id"] . "' style='padding:3px 12px' class='btn btn-warning'>Edit</a>
                    <a href='/admin_feeds/delete_feed/" . $key['feed_id'] . "' style='padding:3px 12px' class='btn btn-danger'>Delete</a>
                    </div>
                </div>
            </article>";
    }
